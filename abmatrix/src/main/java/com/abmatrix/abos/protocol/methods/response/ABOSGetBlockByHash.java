...
public class ABOSGetBlockByHash extends Response<ABOSGetBlockByHash> {
    ...
    public class HeaderBean {
        ...
        private HeaderBean.ProofBean proof;
        ...
        public HeaderBean.ProofBean getProof() {
            return proof;
        }

        public void setProof(HeaderBean.ProofBean proof) {
            this.proof = proof;
        }
        ...
        public class ProofBean {
            ...
            private HeaderBean.ProofBean.BftBean Bft;

            public HeaderBean.ProofBean.BftBean getBft() {
                return Bft;
            }

            public void setBft(HeaderBean.ProofBean.BftBean Bft) {
                this.Bft = Bft;
            }
